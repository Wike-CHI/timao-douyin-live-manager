...
async function main() {
    ...
    switch (command) {
        ...
        case 'help':
            ...
            console.log('  node scripts/构建与启动/integrated-launcher.js start  - 启动所有服务 (默认)');
            console.log('  node scripts/构建与启动/integrated-launcher.js check  - 检查环境和端口');
            console.log('  node scripts/构建与启动/integrated-launcher.js clean  - 清理端口占用');
            console.log('  node scripts/构建与启动/integrated-launcher.js help   - 显示帮助');
            break;
            
        default:
            console.error(`❌ 未知命令: ${command}`);
            console.log('使用 "node scripts/构建与启动/integrated-launcher.js help" 查看帮助');
            process.exit(1);
    }
}
