...
# 默认 SenseVoice ONNX 模型
DEFAULT_MODEL_ID = "models/sherpa-onnx-sense-voice-zh-en-ja-ko-yue-2024-07-17"
...
def create_ast_config(
    ...
    Args:
        model_path: SenseVoice ONNX 模型目录路径
        sample_rate: 音频采样率
    ...
    return ASTConfig(
        ...
        # sherpa-onnx 不需要单独的 VAD/PUNC 模型
        enable_vad=False,
        vad_model_id=None,
        punc_model_id=None,
    )
