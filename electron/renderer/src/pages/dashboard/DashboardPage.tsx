...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="h-full timao-card p-8">
      <h1 className="text-2xl font-semibold text-orange-500 mb-4 flex items-center gap-2">
        <span>🎯</span>
        提猫直播助手 · 功能概览
      </h1>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors font-medium shadow-sm"
              >
                查看订阅套餐 →
              </button>
            </div>
      ...
      <div className="mt-6 grid gap-4 xl:grid-cols-3 md:grid-cols-2">
        <div className="timao-soft-card">
          ...
          <div className="mt-4 text-xs text-orange-500">入口：侧边栏「直播控制台」</div>
        </div>
        ...
        <div className="timao-soft-card">
          ...
          <div className="mt-4 text-xs text-orange-500">入口：「直播控制台」&nbsp;/&nbsp;「直播报告」</div>
        </div>
        ...
        <div className="timao-soft-card">
          ...
          <div className="mt-4 text-xs text-orange-500">入口：「直播控制台」底部 AI 区域</div>
        </div>
        ...
        <div className="timao-soft-card">
          ...
          <div className="mt-4 text-xs text-orange-500">入口：侧边栏「设置」</div>
        </div>
        ...
        <div className="timao-soft-card">
          ...
          <div className="mt-4 text-xs text-orange-500">入口：侧边栏「工具」「设置」</div>
        </div>
      </div>
    </div>
  );
