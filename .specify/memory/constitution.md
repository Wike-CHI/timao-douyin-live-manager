...
<!-- 示例: 每个功能都从独立库开始；库必须自包含、可独立测试、有文档；需要明确目的 - 不允许仅用于组织的库 -->
...
## [SECTION_2_NAME]
<!-- 示例: 额外约束, 安全要求, 性能标准, 等等 -->

[SECTION_2_CONTENT]
<!-- 示例: 技术栈要求, 合规标准, 部署策略, 等等 -->

## [SECTION_3_NAME]
<!-- 示例: 开发工作流, 审查流程, 质量门禁, 等等 -->

[SECTION_3_CONTENT]
<!-- 示例: 代码审查要求, 测试门禁, 部署批准流程, 等等 -->
...
[GOVERNANCE_RULES]
<!-- 示例: 所有 PR/审查必须验证合规性；复杂性必须得到证明；使用 [GUIDANCE_FILE] 获取运行时开发指导 -->
