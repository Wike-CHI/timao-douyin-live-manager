...
- 📖 [完整配置指南](docs/ENV_CONFIGURATION_GUIDE.md)
- 📝 [端口配置文档](docs/PORT_CONFIGURATION.md)
- 🔧 [配置验证脚本](scripts/validate_port_config.py)

---

## ✅ 配置检查清单

- [ ] 运行 `python scripts/setup_env.py`
- [ ] 验证 `python scripts/validate_port_config.py`
