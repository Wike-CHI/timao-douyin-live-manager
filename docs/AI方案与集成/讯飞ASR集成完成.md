...
| `tests/integration/test_xfyun_asr.py` | 独立ASR测试脚本 | ✅ 新增 |
| `tests/integration/test_iflytek_integration.py` | 项目集成测试脚本 | ✅ 新增 |
...
**测试脚本**：`tests/integration/test_xfyun_asr.py`
...
**测试脚本**：`tests/integration/test_iflytek_integration.py`
...
```bash
# 测试独立ASR服务
python tests/integration/test_xfyun_asr.py <audio_file>

# 测试项目集成
python tests/integration/test_iflytek_integration.py
```
...
- `docs/guides/讯飞ASR接入指南.md` - API接入详细说明
